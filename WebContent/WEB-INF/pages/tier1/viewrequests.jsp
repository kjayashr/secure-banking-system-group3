  ...
  <h2>User Requests </h2>
		 <table class="table">
            ...
            <c:when test="${not empty userrequests}">
              ...
              <tr>
	        	<td><a href="<c:url value='/tier1/showrequestdetails/${request.id}/${request.requesterusername}' />" >Show details</a></td>
	        	<td>${request.id}</td>
             ...
             <c:otherwise>    
                ...
                <div class="alert alert-success">
  					<strong>No pending requests to display</strong> <a class="alert-link" href="${pageContext.request.contextPath}/tier1"> Click here to go to home page</a>.
				</div>
                </td>
             </c:otherwise>
             </c:choose>       
