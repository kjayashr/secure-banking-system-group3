		...
		<div class="container">
			...
			<div class="tab-content">
				...
				<div id="transfer" class="tab-pane fade">
					...
					<div class="container">
						<form class="form-horizontal" method="post"
							action="${pageContext.request.contextPath}/Merchanttransfer"
				...
				<div id="GetCustomerPayment" class="tab-pane fade">
					...
					<div class="container">
						<form class="form-horizontal" method="post"
							action="${pageContext.request.contextPath}/GetCustomerPayment">
							<div class="form-group" style="padding-top: 40px">
								<label class="control-label col-sm-2" for="amount">Amount($):</label>
								<div class="col-sm-2">
									<input type="number" class="form-control" id="amount"
							...
							<div class="form-group">
								...
								<div class="form-group">
								<label class="control-label col-sm-2" for="fromName">CustomerName:</label>
								<div class="col-sm-2 dropdown">

									<input type="text" class="form-control" id="fromName"
										placeholder="EnterCustomerName" name="fromName" required>
